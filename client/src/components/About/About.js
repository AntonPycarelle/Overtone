...
const About = ({ items }) => {
    return (
        <div>
            ...
            Na deze jaren ervaring is de <strong> grafische sector, webdesign </strong> en de hele online wereld meer geworden dan enkel een studie. Dag in dag uit zijn wij bezig met het grafische en daarom kunnen wij U altijd <strong> het laatste nieuwe </strong> op grafisch vlak bieden.
